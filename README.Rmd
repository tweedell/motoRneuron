...
knitr::include_graphics("https://raw.githubusercontent.com/tweedell/motoRneuron/master/inst/Recurrence_intervals.jpg")
```
...
```{r echo = FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/tweedell/motoRneuron/master/inst/Dygraph_Cumulative_Sum_Graph.png")
```
